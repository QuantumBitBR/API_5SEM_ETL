...
class TestUpsertRelationTagUS(unittest.TestCase):
   def setUp(self):
      ...
      self.patcher_get_all_projects = patch("src.map.relation_tag_user_story.get_all_projects")
      ...
      self.mock_get_user_storys_by_project = self.patcher_get_user_storys_by_project.start()
   ...
   def test_upsert_relation_tag_us_tag_not_found(self):
      ...
      self.mock_get_user_storys_by_project.return_value = [{"id": 101, "tags": [("tag1",)]}]
      ...
      # Assertions
      self.mock_logger.warning.assert_any_call("Tag 'tag1' not found in the database. Skipping.")
   ...
   def test_upsert_relation_tag_us_user_story_not_found(self):
      ...
      # Assertions
      self.mock_logger.warning.assert_any_call("User story '101' not found in the database. Skipping.")
      mock_conn.commit.assert_not_called()
