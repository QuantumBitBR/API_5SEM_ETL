...
from src.map.fact_status_user_storie import (
    extract_data_2_fact_status_user_storie, process_fact_status_user_storie)
...
class TestFactStatusUserStorie(unittest.TestCase):
   ...
   def test_process_fact_status_user_storie(self, mock_logger_info, mock_upsert, mock_zero, mock_extract):
      # Arrange
      ...
      # Assert
      mock_logger_info.assert_any_call("Starting upsert_fact_progress_user_storie process")
   ...
   def test_extract_data_2_fact_status_user_storie_exception(self, mock_logger_error, mock_logger_info, mock_db, mock_get_user_storys, mock_get_all_projects):
      # Arrange
      ...
      mock_logger_info.assert_any_call("Starting extract_data_2_fact_progress_user_storie process")
      mock_logger_info.assert_any_call("Extracted 1 user stories from project Project 1 (ID: 1)")
      mock_logger_error.assert_any_call("An error occurred: Database error")
      mock_logger_info.assert_any_call("Database connection closed for project processing")
