...
def process_fact_progress_user_storie():
...
def upsert_fact_progress_user_storie(etl_progress):
    ...
    select_fact_progress = "SELECT * FROM public.fato_progresso_user_stories WHERE id_projeto = %s AND id_tag = %s AND id_status = %s"
    insert_fact_progress = "INSERT INTO public.fato_progresso_user_stories (id_projeto, id_tag, id_status, quantidade_user_stories) VALUES (%s, %s, %s, %s)"
    update_fact_progress = "UPDATE public.fato_progresso_user_stories SET quantidade_user_stories = %s WHERE id_projeto = %s AND id_tag = %s AND id_status = %s"
